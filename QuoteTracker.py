...
if __name__ == '__main__':
	...
	parser = arg.parse.ArgumentParser(description= 'Get value of stock with regular interval')
	...
	parser.add_argument("-i", "--interval", type=check_negative,
		help= "Interval for regular checking in minutes. Default values is {}. Minimum vlaue is {}",format(defInterval, minInterval))
	...
	print("")
	print("Getting stock of {} eith regular interval {} minutes".format(companySymbol, interval))
	print("")
	...
	while True:
		...
		if currStockValueis None:
			print("error Happening...")
			print("program Quitting")
			break
		else:
			if currStockValueis[1] < lastStockValue:
				status= "[DOWN]"
